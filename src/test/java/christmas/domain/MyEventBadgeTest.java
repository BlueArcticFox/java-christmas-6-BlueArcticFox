...
public class MyEventBadgeTest {
    ...
    @Test
    void testBadge_1() {
        MyEventBadge myBadge = MyEventBadge.create(20000);
    ...
    @Test
    void testBadge_2() {
        MyEventBadge myBadge = MyEventBadge.create(19999);
    ...
    @Test
    void testBadge_3() {
        MyEventBadge myBadge = MyEventBadge.create(9999);
    ...
    @Test
    void testBadge_4() {
        MyEventBadge myBadge = MyEventBadge.create(4999);
